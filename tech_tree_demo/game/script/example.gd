...
const icon = preload("res://texture/icon.png")
const icon_disabled = preload("res://texture/icon-disabled.png")
const icon_activated = preload("res://texture/icon-activated.png")
